...
Config { 
    font = "xft:UbuntuMono Nerd Font:weight=bold:pixelsize=20:antialias=true:hinting=true",
    bgColor = "#292d3e",
    fgColor = "#f07178",
    lowerOnStart = True,
    hideOnStart = False,
    ...
    commands = [ 
        ...
        Run Com "/home/juampi/.config/xmobar/trayer-padding-icon.sh" [] "trayerpad" 600,
